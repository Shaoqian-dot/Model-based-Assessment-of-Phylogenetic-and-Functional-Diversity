...
getData <- function (DM_phy_func, NOPS, q, 
  ...
  Index_change <- GroupingPairs(DM_phy_func = DM_phy_func, quantile = quantile)
  ...
  # We use species 1/sp 1,...,species m/sp m here for convenience.
  colnames(abundance) <- paste("species", 1:m, sep = ".")
